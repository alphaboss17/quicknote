...
import 'package:quicknote/utilities/dialog/password_resent_email_sent_dialog.dart';
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              const Text(
                "If you forgot your password, Enter your email and we'll send you a reset link",
              ),
              TextField(
